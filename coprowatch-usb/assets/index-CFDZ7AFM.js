const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./web-vXG3yWEz.js","./index-BYM9CpjD.js","./index-06TCD7x9.js"])))=>i.map(i=>d[i]);
import { _ as l, __tla as __tla_0 } from "./index-06TCD7x9.js";
...
let __tla = Promise.all([
    ...
    y = s;
    R = p("Filesystem", {
        web: ()=>l(()=>import("./web-vXG3yWEz.js"), __vite__mapDeps([0,1,2]), import.meta.url).then((t)=>new t.FilesystemWeb)
    });
    C();
});
