const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/web-BgkjQN07.js","assets/index-BYM9CpjD.js","assets/index-pThjosO1.js"])))=>i.map(i=>d[i]);
import { _ as l, __tla as __tla_0 } from "./index-pThjosO1.js";
...
let __tla = Promise.all([
    ...
    y = s;
    R = p("Filesystem", {
        web: ()=>l(()=>import("./web-BgkjQN07.js"), __vite__mapDeps([0,1,2])).then((t)=>new t.FilesystemWeb)
    });
    C();
});
