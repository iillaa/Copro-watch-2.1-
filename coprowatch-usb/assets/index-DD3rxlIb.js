const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./web-DBgLgLEH.js","./index-BYM9CpjD.js","./index-BhIkXDeI.js"])))=>i.map(i=>d[i]);
import { _ as l, __tla as __tla_0 } from "./index-BhIkXDeI.js";
...
let __tla = Promise.all([
    ...
    y = s;
    R = p("Filesystem", {
        web: ()=>l(()=>import("./web-DBgLgLEH.js"), __vite__mapDeps([0,1,2]), import.meta.url).then((t)=>new t.FilesystemWeb)
    });
    C();
});
