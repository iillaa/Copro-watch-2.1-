const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./web-BnBrYmGm.js","./index-BYM9CpjD.js","./index-B_BteyLG.js"])))=>i.map(i=>d[i]);
import { _ as l, __tla as __tla_0 } from "./index-B_BteyLG.js";
...
let __tla = Promise.all([
    ...
    y = s;
    R = p("Filesystem", {
        web: ()=>l(()=>import("./web-BnBrYmGm.js"), __vite__mapDeps([0,1,2]), import.meta.url).then((t)=>new t.FilesystemWeb)
    });
    C();
});
